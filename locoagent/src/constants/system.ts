...
const DEFAULT_PREFIX = `You are LocoAgent, LocoreMind's AI-powered CLI agent.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are LocoAgent, LocoreMind's AI-powered CLI agent, running within the LocoAgent SDK.`
const AGENT_SDK_PREFIX = `You are a LocoAgent agent, built on LocoreMind's LocoAgent SDK.`
